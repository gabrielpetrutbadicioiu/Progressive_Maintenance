...
@Composable
fun CreateProcedureGeneralInfo(
    ...
    isErr:Boolean,
    onProcedureNameChange:(String)->Unit
)
{
    ...
    OutlinedTextField(
        ...
        isError =isErr,
        readOnly =false ,
        onValueChange ={procedure-> onProcedureNameChange(procedure.replaceFirstChar { char->char.uppercase() })},
        placeholder = { Text(text = stringResource(id = R.string.procedure_name_ph))},
        supportingText = { Text(text = stringResource(id = R.string.procedure_name_st))},
